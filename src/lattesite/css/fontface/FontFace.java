...
/** Descriptor for a CSS {@code @font-face} rule, holding font family, source, and optional display/weight/style settings. */
public class FontFace {

    private final String fontFamilyName;
    private final String src;
    private FontFaceDisplay fontDisplay;
    ...
    public void setFontDisplay(FontFaceDisplay fontDisplay) {
    ...
    public FontFaceDisplay getFontDisplay() {
