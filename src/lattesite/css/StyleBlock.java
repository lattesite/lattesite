...
/** A CSS rule block: a selector, an optional responsive breakpoint, and a map of CSS properties. */
public class StyleBlock {
    ...
    /** @return the {@code max-width} breakpoint in pixels, or {@code 0} if this block has no media query */
