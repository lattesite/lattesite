...
public class GoogleMerchantService {
    ...
    public String generate(List<? extends Product> products) throws Exception {
        ...
        for (Product product : products) {
            ...
            if (!StringUtil.isEmpty(product.getGroupID())) {
                xml += this.indentation.repeat(3) + "<g:item_group_id>" + product.getGroupID() + "</g:item_group_id>" + this.nl;
            }
            ...
            xml += this.indentation.repeat(3) + "<g:title>" + escape(product.getTitle()) + "</g:title>" + this.nl;
            xml += this.indentation.repeat(3) + "<g:link>" + escape(product.getLink()) + "</g:link>" + this.nl;
            xml += this.indentation.repeat(3) + "<g:brand>" + escape(product.getBrand()) + "</g:brand>" + this.nl;
            xml += this.indentation.repeat(3) + "<g:description>" + escape(product.getDescription()) + "</g:description>" + this.nl;
            ...
            // Image links
            xml += this.indentation.repeat(3) + "<g:image_link>" + escape(product.getImageURLs().get(0)) + "</g:image_link>" + this.nl;
            // Additional image links
            for (int i = 1; i < product.getImageURLs().size(); i++) {
                xml += this.indentation.repeat(3) + "<g:additional_image_link>" + escape(product.getImageURLs().get(i)) + "</g:additional_image_link>" + this.nl;
            }
            ...
            for (String type : product.getTypes()) {
                xml += this.indentation.repeat(3) + "<g:product_type>" + escape(type) + "</g:product_type>" + this.nl;
            }

            xml += this.indentation.repeat(3) + "<g:color>" + escape(product.getColor()) + "</g:color>" + this.nl;
            xml += this.indentation.repeat(3) + "<g:gender>" + product.getGender().getCode() + "</g:gender>" + this.nl;
            xml += this.indentation.repeat(3) + "<g:material>" + escape(product.getMaterial()) + "</g:material>" + this.nl;
            ...
            if (!StringUtil.isEmpty(product.getProductWeight())) {
                xml += this.indentation.repeat(3) + "<g:product_weight>" + product.getProductWeight() + "</g:product_weight>" + this.nl;
            }
            ...
            if (product.getProperties() != null) {
                for (Map.Entry<String, String> entry : product.getProperties().entrySet()) {
                    ...
                    xml += this.indentation.repeat(3) + "  <g:attribute_name>" + escape(entry.getKey()) + "</g:attribute_name>" + this.nl;
                    xml += this.indentation.repeat(3) + "  <g:attribute_value>" + escape(entry.getValue()) + "</g:attribute_value>" + this.nl;
                    xml += this.indentation.repeat(3) + "</g:product_detail>" + this.nl;
                }
                xml += this.indentation.repeat(2) + "</item>" + this.nl;
            }
