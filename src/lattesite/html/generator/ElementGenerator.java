...
/** Serializes an {@link HTMLRootElement} tree to an HTML string with configurable indentation. */
public class ElementGenerator {
    ...
    /**
     * Serializes the element tree rooted at {@code root} to an HTML string.
     *
