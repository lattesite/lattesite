...
public class HTMLInputElement extends HTMLElement {
    ...
    public void setMaxLength(int maxLength) {
        this.setAttribute("maxlength", Integer.toString(maxLength));
    }
    ...
    /**
     * Sets the {@code list} attribute, linking this input to a {@code <datalist>} element by its ID.
     *
     * @param list the ID of the associated {@code <datalist>} element
     */
