...
/**
 * Subset of ISIC Revision 4 industry classification codes used for Schema.org {@code isicV4} properties.
 *
 * <p>Each constant maps to an integer ISIC class code and a human-readable description.</p>
 *
 * @see <a href="https://unstats.un.org/unsd/publication/seriesm/seriesm_4rev4e.pdf">ISIC Rev.4 specification</a>
 * @see <a href="https://schema.org/isicV4">Schema.org/isicV4</a>
 */
public enum IsicV4Category {
    ...
    CLASS_6201("Computer programming activities", 6201),
