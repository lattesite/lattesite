...
/**
 * Site-wide configuration: locales, output folder, and static asset source folders.
 * Defaults: public folder {@code "public/"}, static root {@code "static_root/"}, static locale {@code "static_locale/"}.
 */
