package lattesite.localization.examples;
...
public class MainExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        locales.add(new Locale("en", "https://www.domain.com/en/"));
        locales.add(new Locale("sv", "https://www.domain.com/sv/"));
        locales.add(new Locale("de", "https://www.domain.com/de/"));
        locales.add(new Locale("fr", "https://www.domain.com/fr/"));
...
Bonjour ! Je m'appelle Homer Simpson et j'ai 36 ans.
    ...
    // Example of a translation utility class
    private static final class TranslationUtil {
        ...
        public static String translate(
            ...
            return translate(locale, english, swedish, german, french, null);
        }
